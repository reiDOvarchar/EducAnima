...
<body>
    ...
    <div class="pesquisa-historico">
        <div class="div-input-pesquisa">
            <div class="div-input">
                <input type="text" id="pesquisar-historico" class="pesquisa-input" placeholder="Pesquisar"> 
            </div>
            <div class="div-lupa">
                <img src="img/lupa.png" id="btn-lupa" class="botao-pesquisa">
            </div>
            
        </div>
        
        <input type="button" value="Limpar Histórico" class="limpar-historico" id="limpar-historico">
    </div>
