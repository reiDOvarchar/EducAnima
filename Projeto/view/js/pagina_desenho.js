        ...
        complete: function (r) {
            if (r.status == 200) {
                ...
                if (r.responseJSON) {
                    ...
                    html += `       </div>`;
                    html += `       <div>`;
                    html += `           <img src="img/favorito_estrelaCheia.png" class="estrela-favorito">`;
                    html += `           <img src="img/favorito_estrelaCheia.png" class="estrela-favorito">`;
                    html += `           <img src="img/favorito_estrelaCheia.png" class="estrela-favorito">`;
                    html += `           <img src="img/favorito_estrelaMetade.png" class="estrela-favorito">`;
                    html += `           <img src="img/favorito_estrelaVazia.png" class="estrela-favorito">`;
                    html += `       </div>`;
                    html += `   </div>`;
                    html += `</div>`;
